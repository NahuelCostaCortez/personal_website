        ...
        <div>
          ...
          <div className="flex items-center justify-center mb-4 sm:mb-8">
            <div className="glass rounded-full p-1 mr-3 sm:mr-4">
              <Image
                ...
                alt="Nahuel Costa - Vibecoder & Growth Strategist profile photo"
                width={40}
                height={40}
            ...
            <div className="text-center">
              <p className="text-sm sm:text-lg text-white/75">
                {language === "en" ? (
                  <>
                    Welcome to my <strong>personal website</strong> 👋
                  </>
                ) : (
                  <>
                    Bienvenido a mi <strong>página web</strong> 👋
                  </>
                )}
              </p>
            </div>
          ...
          <div className="relative mb-6 sm:mb-12">
            <h1 className="text-xl sm:text-3xl md:text-4xl lg:text-5xl font-bold leading-tight text-white px-2 mb-4">
              {language === "en" ? (
                <>
                  ML Researcher and Professor<br />
                  <span className="text-sm sm:text-lg md:text-xl lg:text-2xl font-normal text-white/90 block mt-4">
				  I explore how machine learning can help people make <br />better decisions in healthcare and industry
                  </span>
                </>
              ) : (
                <>
                  Investigador y divulgador en IA <br />
                  <span className="text-sm sm:text-lg md:text-xl lg:text-2xl font-normal text-white/90 block mt-4">
				  Exploro cómo la IA puede ayudar a las personas a tomar <br />mejores decisiones en el ámbito de la salud e industrial
                  </span>
                </>
              )}
            </h1>
            ...
            <div className="absolute -top-8 sm:-top-12 -left-4 sm:-left-8 animate-float-1 transform rotate-12">
              <div className="glass glass-hover rounded-xl sm:rounded-2xl p-2 sm:p-4 w-10 h-10 sm:w-16 sm:h-16 md:w-20 md:h-20 flex items-center justify-center">
                <Image
                  ...
                  alt="Figma design tool - Nahuel Costa UX expertise"
                  width={20}
                  height={20}
