...
const SERVICE_SLUG = "generative-ai-benefits-and-limitations"

export default function GenerativeAIBenefitsAndLimitationsPage() {
      ...
      <main className="pt-20">
        ...
        <section className="py-20 px-4 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto relative z-10">
            ...
            {/* Service Details Grid - Same as workshop */}
        ...
        {/* CUSTOM CONTENT SECTION FOR MACHINE LEARNING INDUSTRIAL TALK */}
        <section className="pt-2 pb-8 px-4">
          <div className="max-w-4xl mx-auto">
            <div className="bg-white/5 backdrop-blur-md rounded-2xl p-8 border border-white/10">
              <h2 className="text-2xl font-bold text-white mb-6">
                {language === "es" ? "Acerca de esta Charla" : "About This Talk"}
              </h2>
