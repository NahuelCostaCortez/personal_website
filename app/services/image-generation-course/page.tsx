                ...
                {language === "es" ? (
                  <>
                    <p className="text-white/80 leading-relaxed mb-4">
                      Este curso está diseñado para empleados cuya formación no sea en IA pero que quieran aprender sobre cómo utilizar las principales herramientas de generación y edición de imágenes con IA.
                    </p>
                    
                    <h3 className="text-xl font-semibold text-white mb-3">Contenido del Curso</h3>
                    <div className="grid md:grid-cols-2 gap-6 mb-6">
                      <div>
                        <h4 className="text-lg font-medium text-white mb-2">Módulo 1: Introducción a las IA Generativas</h4>
                      ...
                      <div>
                        <h4 className="text-lg font-medium text-white mb-2">Módulo 2: Procesamiento de imágenes</h4>
                        <ul className="text-white/80 space-y-1 text-sm">
                          <li>• Casos de uso</li>
                          <li>• Inpaiting/Outpainting</li>
                          <li>• Super Resolución</li>
                          <li>• NanoBanana</li>
                          <li>• Adobe Firefly</li>
                        </ul>
                      </div>
                      <div>
                        <h4 className="text-lg font-medium text-white mb-2">Módulo 3: Ingeniería del prompt</h4>
                        <ul className="text-white/80 space-y-1 text-sm">
                          <li>• El "arte" de crear buenos prompts</li>
                          <li>• Modelos image-to-text</li>
                          <li>• Transferencia de estilos</li>
						  <li>• Controlnet</li>
						  <li>• Charla ética, regulación y autoría</li>
                        </ul>
                      </div>
                      <div>
                        <h4 className="text-lg font-medium text-white mb-2">Módulo 4: Modelos Open Source y otros</h4>
                        <ul className="text-white/80 space-y-1 text-sm">
                          <li>• Hugging Face</li>
                          <li>• Clonación de imagen</li>
